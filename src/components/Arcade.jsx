...
const MuralNeons = () => {
  ...
  return (
    <group dispose={null}>
      ...
      >
        <muralNeonsMaterial1 ref={muralNeonMaterial1} />
      </mesh>
      <mesh
        castShadow
      ...
      >
        <muralNeonsMaterial2 ref={muralNeonMaterial2} />
      </mesh>
      <mesh
        castShadow
      ...
      >
        <muralNeonsMaterial3 ref={muralNeonMaterial3} />
      </mesh>
    </group>
  );
};
...
const Switch = (props) => {
  ...
  return (
    <group dispose={null}>
      ...
      >
        <meshStandardMaterial color={"#e6e8d1"} />
      </mesh>
    </group>
  );
};
